...
MAKE_LITERAL_CHAR(0)
MAKE_LITERAL_RATIONAL(0,1)  ;34
MAKE_LITERAL_RATIONAL(1,1)  ;51
MAKE_LITERAL_RATIONAL(-1,1)  ;68
MAKE_LITERAL_RATIONAL(6,1)  ;85
MAKE_LITERAL_RATIONAL(8,1)  ;102
MAKE_LITERAL_RATIONAL(3,1)  ;119
MAKE_LITERAL_RATIONAL(2,1)  ;136
MAKE_LITERAL_RATIONAL(5,1)  ;153
...
MAKE_LITERAL_PAIR(const_tbl+102,const_tbl+204)
MAKE_LITERAL_PAIR(const_tbl+85,const_tbl+221)
...
;body
; varfree:fold-left
mov rax, qword[fvar_tbl+WORD_SIZE*67 ]
CLOSURE_ENV rdx, rax
push rdx
push qword[rbp+8*1]   ;old ret addr
...
mov qword [fvar_tbl + WORD_SIZE*67], rax
mov rax, SOB_VOID_ADDRESS
...
; set  varfree:+ to  lambdaOpt ):seq:   set  VarParam:x to box  VarParam:x,applicTP  boxGetapplic  boxGetboxGet number 0,1boxGet
; lambdaOpt ):seq:   set  VarParam:x to box  VarParam:x,applicTP  boxGetapplic  boxGetboxGet number 0,1boxGet

CREATE_EXT_ENV 3
mov rdx, rax
MAKE_CLOSURE(rax, rdx, Lcode33)
jmp Lcont33
Lcode33:
FIX_LAMBDA_OPT_STACK 1
push rbp
...
; set  varfree:* to  lambdaOpt ):seq:   set  VarParam:x to box  VarParam:x,applicTP  boxGetapplic  boxGetboxGet number 1,1boxGet
...
; set  varfree:/ to applic   lambda (/):seq:   set  VarParam:/ to box  VarParam:/, lambdaOpt x):seq:   set  VarParam:x to box  VarParam:x, set  VarParam:y to box  VarParam:y, if: applic  boxGetboxGetthen: applicTP  boxGet number 1,1boxGetelse applicTP  boxGetboxGetboxGetboxGetapplic  boxGetboxGet
...
push 1
;body
; lambda (^comparator):seq:   set  VarParam:^comparator to box  VarParam:^comparator, set  varfree:= to applic  boxGetapplic  boxGetboxGet set  varfree:< to applic  boxGetapplic  boxGetboxGet
...
push rbp
mov rbp, rsp
;seq:   set  VarParam:^comparator to box  VarParam:^comparator, set  varfree:= to applic  boxGetapplic  boxGetboxGet set  varfree:< to applic  boxGetapplic  boxGetboxGet
;box  VarParam:^comparator,
mov rax, qword[rbp+8 * (4+0)]
MALLOC rbx, WORD_SIZE
mov [rbx], rax
...
; set  varfree:= to applic  boxGetapplic  boxGetboxGet
;applic  boxGetapplic  boxGetboxGet
;applic  boxGetboxGet
mov rax, qword[rbp+8*2]
                                        mov rax, qword[rax+8*1]
...
mov qword [fvar_tbl + WORD_SIZE*54], rax
mov rax, SOB_VOID_ADDRESS
...
;def min
; lambdaOpt ):seq:   set  VarParam:args to box  VarParam:args,applicTP   varfree:fold-left lambda (x y):seq:   set  VarParam:x to box  VarParam:x, set  VarParam:y to box  VarParam:y, if: applic   varfree:<boxGetboxGetthen: boxGetelse boxGetapplic   varfree:carboxGetboxGet
...
push rbp
mov rbp, rsp
;seq:   set  VarParam:args to box  VarParam:args,applicTP   varfree:fold-left lambda (x y):seq:   set  VarParam:x to box  VarParam:x, set  VarParam:y to box  VarParam:y, if: applic   varfree:<boxGetboxGetthen: boxGetelse boxGetapplic   varfree:carboxGetboxGet
;box  VarParam:args,
mov rax, qword[rbp+8 * (4+0)]
MALLOC rbx, WORD_SIZE
mov [rbx], rax
...
;applicTP   varfree:fold-left lambda (x y):seq:   set  VarParam:x to box  VarParam:x, set  VarParam:y to box  VarParam:y, if: applic   varfree:<boxGetboxGetthen: boxGetelse boxGetapplic   varfree:carboxGetboxGet
;args
mov rax, qword[rbp+8 * (4+0)]
                        mov rax,qword[rax]
...
push rax
; lambda (x y):seq:   set  VarParam:x to box  VarParam:x, set  VarParam:y to box  VarParam:y, if: applic   varfree:<boxGetboxGetthen: boxGetelse boxGet
...
push rbp
mov rbp, rsp
;seq:   set  VarParam:x to box  VarParam:x, set  VarParam:y to box  VarParam:y, if: applic   varfree:<boxGetboxGetthen: boxGetelse boxGet
;box  VarParam:x,
mov rax, qword[rbp+8 * (4+0)]
MALLOC rbx, WORD_SIZE
mov [rbx], rax
...
;applic   varfree:apply varfree:min Pair:
...
;applic   varfree:apply varfree:min number 5,1 number 1,1 number 3,1 Pair:
mov rax, const_tbl+238
push rax
